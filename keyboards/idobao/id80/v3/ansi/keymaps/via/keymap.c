...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_80_ansi(
        ...
        _______, UG_TOGG, _______, UG_NEXT, UG_HUEU,  UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, UG_SPDU, UG_SPDD, _______, _______, KC_VOLD,
        _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,          _______, _______, UG_PREV, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_PGUP,
