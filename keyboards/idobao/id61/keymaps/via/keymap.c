...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi(
        ...
        _______, _______, KC_UP,   _______, _______, UG_TOGG, UG_HUEU, UG_SATU, UG_VALU, UG_SPDU, KC_PSCR, KC_HOME, KC_END,  _______,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, UG_NEXT, UG_HUED, UG_SATD, UG_VALD, UG_SPDD, KC_PGUP, KC_PGDN, _______,
