...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_split_3x5_3(
    QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      UG_TOGG,  UG_HUED, UG_HUEU, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      UG_NEXT,  UG_SATD, UG_SATU, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      UG_PREV, UG_VALD, UG_VALU, XXXXXXX, XXXXXXX,
