...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_latin_hhkb(
        UG_TOGG,        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, 
    ...
    [2] = LAYOUT_60_latin_hhkb(
        UG_TOGG, UG_NEXT,   UG_HUEU, UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, UG_NEXT,   UG_SPDU, UG_SPDD,  KC_F11,  KC_F12,  KC_DEL, 
        _______, UG_TOGG, _______, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, UG_NEXT, _______, _______, _______, QK_BOOT,
        _______, _______, _______, _______, _______, _______, _______, _______, UG_SPDU, UG_SPDD, _______, _______,          _______,
