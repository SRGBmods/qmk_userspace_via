...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_INDEX] =  LAYOUT_all(
        ...
        _______,  _______,    TO(0),    TO(1),  _______,  _______,     _______,  _______,  _______,  _______,  RGB_M_P,  UG_PREV, UG_PREV, UG_TOGG,
        _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  _______,  _______,  UG_SPDD,  UG_SPDU,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  UG_VALD,  UG_VALU,  KC_UP,              _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_WIN_INDEX] = { ENCODER_CCW_CW(UG_HUED, UG_HUEU) },
    [_MAC_INDEX] = { ENCODER_CCW_CW(UG_HUED, UG_HUEU) }
};
#endif
