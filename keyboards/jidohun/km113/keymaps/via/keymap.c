...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, UG_PREV, UG_NEXT, _______,                 _______,
        _______, _______, _______, _______, UG_NEXT, _______, _______, KC_PSCR,  KC_PGUP, KC_DEL,  _______, _______, _______, _______,                  TO(0),   _______,
        _______, _______, _______, _______, _______, _______, _______, KC_INS,   KC_PGDN, KC_END,  _______, _______,          _______,                  TO(1),   _______,
        _______,          _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, UG_VALU,                  TO(2),   _______,
        _______, GU_TOGG, _______,                           UG_TOGG,                              _______, _______, _______, UG_SPDD, UG_VALD, UG_SPDU,TO(3),   _______
    ),
