...
[_FN] = LAYOUT(
  ...
  KC_TRNS,  KC_HOME, KC_TRNS,  KC_END, KC_TRNS, KC_MUTE,                KC_TRNS, KC_TRNS, UG_HUEU, UG_SATU, UG_VALU,  KC_DEL,
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                KC_TRNS, KC_TRNS, UG_SPDU, UG_NEXT, UG_TOGG
)
};
