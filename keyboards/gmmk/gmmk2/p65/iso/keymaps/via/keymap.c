...
[1] = LAYOUT_65_iso_blocker(
  ...
  _______,  _______,  UG_HUEU,  UG_HUED,  UG_SPDD,  UG_SPDU,  KC_MUTE,  KC_VOLU,  KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,   UG_VALU,  KC_HOME,
  _______,  _______,  _______,                                QK_BOOT,                                _______,  _______,  UG_PREV,  UG_VALD,  UG_NEXT),
