...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FN1] = { ENCODER_CCW_CW(UG_HUED, UG_HUEU), ENCODER_CCW_CW(UG_SATD, UG_SATU), ENCODER_CCW_CW(UG_VALD, UG_VALU) },
    [_FN2] = { ENCODER_CCW_CW(UG_PREV, UG_NEXT), ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },
