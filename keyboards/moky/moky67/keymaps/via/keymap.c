...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT( /* Base */
        ...
        QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_NEXT,                   _______,
        _______, TO(0),   TO(2),   _______, _______, _______, _______, _______, _______, UG_TOGG, _______, _______,          _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,          UG_VALU,
        _______, GU_TOGG, _______,                                     EE_CLR,                    _______, _______,          _______, UG_SPDD, UG_VALD, UG_SPDU),
    ...
    [3] = LAYOUT(  /* FN */
        ...
        _______, TO(0),   TO(2),   _______, _______, _______, _______, _______, _______, UG_TOGG, _______, _______,          _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,          UG_VALU,
        _______, _______, _______,                                     EE_CLR,                    _______, _______,          _______, UG_SPDD, UG_VALD, UG_SPDU),
};
