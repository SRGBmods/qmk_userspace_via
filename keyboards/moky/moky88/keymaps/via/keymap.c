...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_tkl_f13_ansi( /* Base */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_SPDD, UG_SPDU, UG_TOGG, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_SATD, UG_SATU, UG_NEXT, _______, _______, _______,
        ...
        _______, GU_TOGG, _______,                            _______,                            _______, _______, _______, _______, UG_HUED, UG_VALD, UG_HUEU),
