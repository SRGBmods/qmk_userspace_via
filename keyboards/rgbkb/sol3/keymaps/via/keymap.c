...
//#define RGB_ADJ  LT(_ADJUST, UG_TOGG)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL,  KC_LGUI, KC_LALT, UG_TOGG, ADJUST,  KC_SPC,  KC_PGDN, KC_DEL, KC_ENT,  KC_PGUP, KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RCTL,
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, UG_HUED, UG_VALD, UG_HUEU, RGB_RST, _______, DM_REC1,                   _______, _______, KC_P4,   KC_P5,   KC_P6,   _______, _______,
        _______, UG_SPDD, _______, UG_SPDU, _______, _______, DM_RSTP,                   _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, GAME,
        _______, UG_PREV,UG_TOGG, UG_NEXT, _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_NUM,  QWERTY,  COLEMAK,
