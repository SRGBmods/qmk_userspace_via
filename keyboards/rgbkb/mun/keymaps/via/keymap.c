...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, UG_TOGG, ADJUST,  KC_SPC,  KC_DEL,    KC_ENT,    KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_RCTL,

        KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_MPRV,                                        UG_HUEU, UG_HUED, UG_PREV,UG_TOGG, UG_NEXT
    ),
    ...
    [_ADJUST] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,  KC_F12,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
        _______, UG_SATD, UG_VALU, UG_SATU, QK_BOOT, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   _______, _______,
        _______, UG_HUED, UG_VALD, UG_HUEU, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   _______, _______,
        _______, UG_SPDD, _______, UG_SPDU, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, GAME,
        _______, UG_PREV,_______, UG_NEXT, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_NUM,  QWERTY, COLEMAK,
