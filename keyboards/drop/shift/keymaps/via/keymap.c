...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_1800_ansi(
        ...
        _______, UG_TOGG, UG_VALU, UG_SPDU, UG_HUEU, UG_SATU, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______,
        _______, UG_NEXT, UG_VALD, UG_SPDD, UG_HUED, UG_SATD, _______, _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______,
