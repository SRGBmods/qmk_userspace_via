...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [WIN_FN] =LAYOUT(
    ...
    KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, UG_HUEU,          KC_TRNS, KC_MNXT, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            UG_PREV,UG_HUED, UG_TOGG, KC_TRNS, KC_TRNS, KC_TRNS
    )
};
