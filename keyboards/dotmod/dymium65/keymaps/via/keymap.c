...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    UG_TOGG,       KC_Q,        KC_W,        KC_E,  KC_R,  KC_T,  KC_Y,      KC_U,  KC_I,  KC_O,         KC_P,         UG_HUEU,         UG_HUED,          KC_BACKSLASH,   KC_TRNS,
    KC_CAPS_LOCK,  KC_A,        KC_S,        KC_D,  KC_F,  KC_G,  KC_H,      KC_J,  KC_K,  KC_L,         UG_SATD,      UG_SATU,                           KC_ENTER,       KC_TRNS,
    KC_LEFT_SHIFT,              KC_Z,        KC_X,  KC_C,  KC_V,  KC_B,      KC_N,  KC_M,  KC_COMMA,     MO(_LN),      KC_SLASH,                          KC_RIGHT_SHIFT, UG_VALU,
    KC_LEFT_CTRL,  KC_LEFT_GUI, KC_LEFT_ALT,                      KC_SPACE,                UG_NEXT,      _______,                       KC_RIGHT_CTRL,    UG_SPDD,        UG_VALD,        UG_SPDU
    ),
    [_LN] = LAYOUT(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_LN] =     { ENCODER_CCW_CW(UG_SATD, UG_SATU) },
    [_MT] =     { ENCODER_CCW_CW(UG_SPDD, UG_SPDU) },
};
#endif
