...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, UG_TOGG, UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, _______, KC_PSCR, KC_SCRL, KC_PAUS,   QK_BOOT, KC_PGUP,
        KC_CAPS, UG_SPDU, UG_SPDD, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_PGDN,
